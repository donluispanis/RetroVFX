...
Farbraush es un grupo de \emph{demosceners} de origen alemán que empezó a ser notado a partir de diciembre del 2000, con su octava producción, llamada \emph{The product}\footnote{\url{http://www.farbrausch.de/prod&which=17.py}}.\\

hablar sobre origen de su nombre, componentes si se puede, decir que la 41 es la obra más popular de pouet y que han ganado muchos premios
...
\begin{figure}[h]
	\centering
	\includegraphics[width=5cm]{archivos/fr-043-rove}
	\caption{Farbrausch 43: Rove}
	\label{fig:rove}
\end{figure}
...
drsgth rgth   eryt \ref{fig:debris} rghfthj  dsdf \ref{fig:rove} df aehf er grha wrtnjfa\ref{fig:magellan} er h
